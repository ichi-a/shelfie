  ...
  return (
    <div className="max-w-420 mt-30 flex flex-col items-center justify-center py-4 text-center mx-auto">
      ...
      <div className=" mt-80 mx-auto w-13/14 max-w-400 grid grid-cols-1 gap-5 bg-[#C89B3C]/10 justify-items-center p-4 pt-9 rounded border border-[#1F4D4F]/30">
        <p className="text-xl font-serif font-bold p-1 text-[#1F4D4F]">
          アプリ紹介
        </p>
        <div className="h-1 w-62 bg-[#C89B3C] mx-auto mb-15" />
        <p className="text-[#1F4D4F]/90 border-b-2 border-[#1F4D4F]/20 pb-1 font-medium mt-8">
        ...
        <p className="text-[#1F4D4F]/90 border-b-2 border-[#1F4D4F]/20 pb-1 font-medium mt-26">
